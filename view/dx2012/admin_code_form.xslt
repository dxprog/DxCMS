...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl">
	...
	<xsl:template match="/">
		...
		<form method="post" action="/admin/code/create/">
			<xsl:if test="//id">
				<xsl:attribute name="action">/admin/code/update/<xsl:value-of select="//id" />/</xsl:attribute>
			</xsl:if>
			...
			<div class="form">
				...
				<div class="field">
					...
					<input type="text" name="github" id="github" value="{//meta/github}" />
				</div>
				<div class="field">
					<label for="demo">Demo Link</label>
					<input type="text" name="demo" id="demo" value="{//meta/demo}" />
				</div>
				<div class="field">
					<label for="source">Source Download</label>
					<input type="text" name="source" id="source" value="{//meta/source}" />
				</div>
				<div class="field">
				...
				<div class="buttons">
					<input type="hidden" name="contentType" value="code" />
